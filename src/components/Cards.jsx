  ...
  return (
    <section className={`${styles.flexCenter} flex-row flex-wrap`}>
      <div className="flex h-[620px] w-full items-end justify-center" style={{ backgroundImage: `url(${solution})` }}>
        <div className="grid grid-cols-2 gap-5 md:grid-cols-1 lg:grid-cols-4 pb-8 px-4">
          ...
          <a href="/#services">
            <div className="group relative cursor-pointer border border-white rounded-md items-center justify-center overflow-hidden">
              <div className="h-56 w-72 bg-slate-900/20">
                ...
                <div className="absolute inset-0 flex translate-y-[50%] sm:translate-y-[20%] flex-col items-center justify-center px-6 text-center transition-all duration-500 group-hover:translate-y-30 sm:group-hover:translate-y-0">
                  <div className='pb-4'>
                  ...
                  <p className="invisible xs:visible sm:text-md text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
