    ...
    <section className={`${styles.flexCenter} flex-row flex-wrap sm:mb-20 mb-6`}>
      <div className="flex w-full items-center justify-center bg-gray-800 py-14">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="group relative cursor-pointer rounded-lg items-center justify-center overflow-hidden transition-shadow ">
            <div className="h-96 w-72 bg-gray-900">
